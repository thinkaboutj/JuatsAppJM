...
public class PnlChat extends javax.swing.JPanel {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        String textoMensaje = this.txtMensaje.getText().trim();
        ...
        // Actualizar el contenido del TextArea para mostrar el mensaje enviado
        String mensajeEnviado = "Tú: " + mensaje.getTexto() + "\n"; // Construir el mensaje enviado
        this.areaChat.append(mensajeEnviado);
