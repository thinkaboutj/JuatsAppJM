...
public class Login extends javax.swing.JFrame {
    ...
    public void validarUsuario() {
        if (txtTelefonoLogin.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Digite un número de teléfono");
            return;
        }

        if (txtContrasenyaLogin.getText().isEmpty()) {
        ...
        usuarioIngresado.setContrasenya(encriptar(txtContrasenyaLogin.getText()));

        for (Usuario user : usuarios) {
            if (user.getTelefono().equals(usuarioIngresado.getTelefono())) {
                if (user.getContrasenya() != null && user.getContrasenya().equals(usuarioIngresado.getContrasenya())) {
                    usuario = user;
                    break;
                }
            }
